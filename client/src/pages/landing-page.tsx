...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-primary selection:text-primary-foreground overflow-x-hidden">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-[#0f172a]/80 backdrop-blur-md border-b border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-black font-bold text-xl shadow-[0_0_15px_rgba(245,158,11,0.3)]">
              B
            </div>
          ...
          <div className="hidden md:flex items-center gap-8">
            <div className="flex items-center gap-4 text-sm font-medium text-gray-400">
              ...
              <button className="hover:text-primary transition-colors">CHINESE</button>
              <span className="text-gray-700">|</span>
              <button className="hover:text-primary transition-colors">MALAY</button>
            </div>
            
            <Button 
              onClick={handleLoginClick}
              className="bg-primary hover:bg-primary/90 text-black font-bold px-6 rounded-full shadow-[0_0_20px_rgba(245,158,11,0.2)] transition-all hover:shadow-[0_0_30px_rgba(245,158,11,0.4)]"
            >
        ...
        {/* Mobile Nav */}
        {mobileMenuOpen && (
          <div className="md:hidden bg-[#0f172a] border-b border-white/10 p-4 space-y-4 animate-in slide-in-from-top-5">
            <div className="flex flex-col gap-4 text-sm font-medium text-gray-400">
              <button className="text-left hover:text-primary">ENGLISH</button>
              <button className="text-left hover:text-primary">CHINESE</button>
              <button className="text-left hover:text-primary">MALAY</button>
            </div>
      ...
      {/* 2. Hero Section */}
      <section className="relative pt-20 h-[600px] sm:h-[700px] overflow-hidden">
          ...
          >
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
                <div className="max-w-2xl animate-in slide-in-from-left-10 fade-in duration-700 delay-200">
                  <h1 className="text-5xl sm:text-7xl font-bold text-white mb-6 leading-tight">
                    {slide.title.split(' ').map((word, i) => (
                      <span key={i} className={i === 0 ? "text-primary block" : "block"}>{word} </span>
                    ))}
                  </h1>
                  <p className="text-xl text-gray-300 mb-8 border-l-4 border-primary pl-6">
                    {slide.subtitle}
                  </p>
                  <Button 
                    onClick={handleLoginClick}
                    size="lg" 
                    className="text-lg px-8 h-14 rounded-full bg-gradient-to-r from-primary to-yellow-400 text-black font-bold hover:scale-105 transition-transform"
                  >
      ...
      <section className="py-24 bg-[#0b1120] relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Feature 1 */}
            <div className="group hover:bg-white/5 p-8 rounded-2xl transition-colors border border-white/5 hover:border-primary/30">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="bg-white/5 p-8 rounded-xl border border-white/10 text-left">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           ...
           <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
             {CRYPTO_ASSETS.map((asset) => (
               <div key={asset.symbol} className="bg-white/5 p-4 rounded-lg flex items-center justify-between hover:bg-white/10 transition-colors cursor-pointer">
                 <div>
      ...
      {/* 6. CTA Section */}
      <section className="py-24 bg-gradient-to-b from-[#0f172a] to-[#0b1120] text-center">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-5xl font-bold mb-12">Ready to Start Trading?</h2>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="h-16 px-8 text-lg font-bold bg-[#25D366] hover:bg-[#25D366]/90 text-white rounded-full flex items-center gap-3">
            ...
            <Button size="lg" className="h-16 px-8 text-lg font-bold bg-[#0088cc] hover:bg-[#0088cc]/90 text-white rounded-full flex items-center gap-3">
      ...
      {/* 7. Footer & Legal */}
      <footer className="bg-[#050a14] py-16 border-t border-white/5 text-xs text-gray-500 leading-relaxed">
