...
export const loginAttempts = new Counter({ name: 'auth_login_attempts_total', help: 'Total login attempts', registers: [registry], labelNames: ['result'] })
export const rateLimitHits = new Counter({ name: 'rate_limit_hits_total', help: 'Total rate limit hits', registers: [registry], labelNames: ['key'] })
